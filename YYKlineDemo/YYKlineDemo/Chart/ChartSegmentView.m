...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if(self) {
        ...
        self.backgroundColor = YYKlineStyleConfig.sharedConfig.assistBackgroundColor;
    }
    return self;
}
...
- (UIView *)indicatorView {
    if(!_indicatorView) {
        ...
        _indicatorView.backgroundColor = YYKlineStyleConfig.sharedConfig.assistBackgroundColor;
